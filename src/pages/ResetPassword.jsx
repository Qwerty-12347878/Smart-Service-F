...
const ResetPassword = () => {
    ...
    return (
        <div className="w-full min-h-screen flex items-center justify-center pt-20 px-4 z-10 relative">
            ...
            >
                <h2 className="text-2xl font-extrabold text-white mb-4">Reset Password</h2>
                <p className="text-slate-400 mb-6">Set a fresh password so you can get back to your bookings, profile details, and service history.</p>
                ...
                <p className="mt-5 text-sm text-slate-400">
                    Want to go back? <Link to="/login" className="text-pink-400 hover:text-pink-300">Login</Link>
                </p>
            </motion.div>
        </div>
    );
